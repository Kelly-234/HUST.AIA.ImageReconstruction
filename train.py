...
def parse_args():
    ...
    parser.add_argument('--task', type=str, default="edge", choices=["reconstruction", "edge", "denoise"])
    parser.add_argument('--exp-name', type=str, default='default')
    parser.add_argument('--resume-from', type=str, default=None)#resume-from参数用于指定某种恢复操作的文件路径
...
def main():
    ...
    optimizer = optim.Adam(model.parameters(), lr=args.learning_rate)#用动量梯度下降法优化
