...
class HourGlass(BaseModel):
    def __init__(self, block=Bottleneck, num_stacks=2, num_blocks=4, num_classes=1):
        super(HourGlass, self).__init__()

        self.inplanes = 64
        self.num_feats = 128
        self.num_stacks = num_stacks
        self.conv1 = nn.Conv2d(1, self.inplanes, kernel_size=7, stride=1, padding=3, bias=True)
    ...
    def forward(self, x):
        ...
        return torch.sigmoid(out[-1].reshape(out[-1].shape[0], -1))
